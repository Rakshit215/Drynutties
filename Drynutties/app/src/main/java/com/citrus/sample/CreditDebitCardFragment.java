...
//            });
            ...
            Callback<TransactionResponse> callback = new Callback<TransactionResponse>() {
                ...
                @Override
                public void error(CitrusError error) {
                    ((UIActivity) getActivity()).onPaymentComplete(null);

                    Utils.showToast(getActivity(),"From response"+ error.getMessage());
...
//                    });
                ...
                e.printStackTrace();
                Utils.showToast(getActivity(),"From catch"+ e.getMessage());
