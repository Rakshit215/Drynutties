...
import com.ecommerce.r1000.rakshit.drynutties.TransactionSuccess;
...
public class UIActivity extends ActionBarActivity implements UserManagementFragment.UserManagementInteractionListener, WalletFragmentListener {
    ...
    public void onPaymentComplete(TransactionResponse transactionResponse) {
        ...
        if (transactionResponse != null) {
            ...
            Utils.showToast(mContext, transactionResponse.getJsonResponse().toString());
            Utils.showToast(mContext, transactionResponse.toString());

           ob= new TransactionSuccess(this,transactionResponse.getJsonResponse().toString());
           ob.execute();
