...
public class payu extends ActionBarActivity
{
    ...
    public void makePayment(View view) {
        if (amt.getText().toString().equals("") || (Double.parseDouble(amt.getText().toString()) == 0.0)) {
            ...
            String hashSequence = "jJVB2F" + "|" + "0nf7" + "|" + amt.getText().toString() + "|" + "parrot" + "|" + "rakshit" + "|"
                    + "rakshitj21@gmail.com" + "|" + "" + "|" + "" + "|" + "" + "|" + "" + "|" + "" + "|" + "ds0j9R3v";
            params.put("key", "jJVB2F");
            params.put("MerchantId", "5252326");
            ...
            params.put("SURL", "www.drynutties.com/porder.php");
            params.put("FURL", "www.drynutties.com/porder.php");
            params.put(SdkConstants.PRODUCT_INFO, "parrot");
            params.put(SdkConstants.FIRSTNAME, "rakshit");
            params.put(SdkConstants.EMAIL, "rakshitj21@gmail.com");
            params.put(SdkConstants.PHONE, "9760264265");
            params.put(SdkConstants.AMOUNT, amt.getText().toString());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_payu, menu);
        return true;
    }
