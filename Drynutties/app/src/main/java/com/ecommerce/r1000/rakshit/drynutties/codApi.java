 ...
 */
public class codApi extends AsyncTask<String,String,String>
{
    Activity con;
    JSONObject jo=null;
    ...
    public     String link="http://192.168.137.1/drynutties/cod_api.php";
    public    String line = "abc";
    public codApi(Activity c)
    {
        this.con=c;
        ...
        try
        {
            ...
            result.append("=");
            result.append(URLEncoder.encode(sp.getString("amt", "0.0"), "UTF-8"));


            result.append("&");
            result.append(URLEncoder.encode("cod", "UTF-8"));
            result.append("=");
            result.append(URLEncoder.encode("Yes", "UTF-8"));
