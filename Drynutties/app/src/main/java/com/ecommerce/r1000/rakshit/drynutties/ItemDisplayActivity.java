...
public class ItemDisplayActivity extends ActionBarActivity implements ItemDisplayFragment.OnFragmentInteractionListener {
    String TITLES[];
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Log.e("Element",getIntent().getExtras().getString("item"));
        base.putString("base",getIntent().getExtras().getString("item"));
        ItemDisplayFragment frag= new ItemDisplayFragment();
        frag.setArguments(base);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_item_display, menu);
        return true;
    }
