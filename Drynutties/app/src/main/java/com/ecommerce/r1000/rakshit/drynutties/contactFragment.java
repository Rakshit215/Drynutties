...
public class contactFragment extends android.support.v4.app.Fragment
{
    ...
    String scr[]={"PHONE CALL","SMS","Email"};
    int img[]={R.drawable.contact,R.drawable.sms,R.drawable.gmail};
...
View rootView= inflater.inflate(R.layout.fragment_contact, container, false);
        ...
        mRecyclerView = (RecyclerView)rootView.findViewById(R.id.contactview);
...
public ImageView iv;
        ...
        public class CustomViewHolder extends RecyclerView.ViewHolder {
            ...
            public CustomViewHolder(View view) {
                super(view);
                title=(TextView)view.findViewById(R.id.contacttext);
iv=(ImageView)view.findViewById(R.id.conimg);
        ...
        {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.contact_single, null);
