 ...
 */
public class deleteCartItem extends AsyncTask<String,String,String>
{
    public Activity con;
    public String link="http://192.168.137.1/drynutties/deleteCartItem_api.php";

    public String id;
    public StringBuilder result;
    public  StringBuilder br;

    public deleteCartItem(Activity c,String id,String uid)
    {
        this.con=c;
        this.id=uid;
...
br=new StringBuilder();
    ...
    protected void onPostExecute(String s) {
        ...
        new CartCheckapi(con,id,1).execute();
